...
<div class="container" style="margin-top: 10px;">
 ...
 <div class="container" id="list_app">
  ...
  <div class="row text-center" style="margin-top: 10px">
   <ul class="pagination">
    <li v-if="store.startPage>1"><a class="nav-link" @click="store.pageChange(store.startPage-1)">&laquo;</a></li>
    <li v-for="i in store.range" :class="i===store.curpage?'active':''" @click="store.pageChange(i)"><a class="nav-link">{{i}}</a></li>
    <li v-if="store.endPage<store.totalpage" @click="store.pageChange(store.endPage+1)"><a class="nav-link">&raquo;</a></li>
   </ul>
  </div>
 </div>
