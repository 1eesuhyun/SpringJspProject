         ...
         <tbody>
           ...
           <tr v-for="(data,index) in store.detail.tList" :key="index">
             ...
             <td class="text-right" width=15%>
              <img :src="store.detail.iList[index]" style="width: 180px;height: 150px"></td>
           </tr>
         </tbody>
       </table>
       <table class="table">
          ...
          <tbody>
           <tr>
            ...
            <td class="text-right" width="20%">
             <button class="btn-xm btn-success" v-if="rStore.sessionId===rvo.id" @click="rStore.toggleUpdate(rvo.no,rvo.msg)">{{rStore.upReplyNo===rvo.no?'취소':'수정'}}</button>
             <button class="btn-xm btn-danger" v-if="rStore.sessionId===rvo.id" @click="rStore.replyDelete(rvo.no)">삭제</button>
             </td>
           </tr>
           <tr>
           ...
           <tr>
            <td colspan="2" class="text-left" v-if="rStore.upReplyNo===rvo.no">
	           ...
	           <button type="button" class="btn-success" style="width: 100px;height: 107px;float: left" @click="rStore.replyUpdate(rvo.no)">수정하기</button>
	          </td>
           </tr>
          </tbody>
         </table>
        ...
        <tbody>
         <tr>
          <td>
           ...
           <button type="button" class="btn-success" style="width: 100px;height: 107px;float: left" @click="rStore.replyInsert()">댓글 쓰기</button>
          </td>
         </tr>
        </tbody>
       </table>
